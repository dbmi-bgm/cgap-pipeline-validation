...
####### III
# run granite
granite validateVCF -i ${accession}.merged.vcf -o ${accession}.het.snv.json -p ${pedigree%%.*}.${sample_1}.json ${pedigree%%.*}.${sample_2}.json --anchor ${sample_1}_${accession} ${sample_2}_${accession} --het ${sample_1}_${accession} ${sample_2}_${accession}
granite validateVCF -i ${accession}.merged.vcf -o ${accession}.het.indel.json -p ${pedigree%%.*}.${sample_1}.json ${pedigree%%.*}.${sample_2}.json --anchor ${sample_1}_${accession} ${sample_2}_${accession} --het ${sample_1}_${accession} ${sample_2}_${accession} --type INS DEL
